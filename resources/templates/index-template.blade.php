...
@section('title', 'Dynamic View for {{TABLE_NAME}}')
    ...
    <div class="row">
       <div class="col-md-12">
          <div class="card border-0 shadow rounded">
             <div class="card-body">
                <a href="http://127.0.0.1:8001/{{TABLE_NAME}}/create" class="btn btn-md btn-success mb-3">TAMBAH DATA</a>
                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                            ...
                            <tbody>
                               ...
                               <tr>
                                  ...
                                  <td class="text-center">
                                     <!-- You can add any actions like edit or delete here -->
                                  </td>
                               </tr>
                               @endforeach
                            </tbody>
                   ...
                   <div class="row">
                      <div class="col-sm-12 col-md-5">
                         <div class="dataTables_info" id="DataTables_Table_0_info" role="status" aria-live="polite">Showing 1 to {{ count($data) }} of {{ count($data) }} entries</div>
                      </div>
