         ...
         <div class="row">
            ...
            <div class="col-md-12">
               <div class="card border-0 shadow rounded">
                  <div class="card-body">
                    <form action="{{ route('biro.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        @component('components.fileinput', [
                            'label' => 'Gambar Ketua Biro',
                            'name' => 'gambar_pimpinan',
                            'accept' => 'image/*',
                            'col' => 'col-md-5',
                            'value' => $data->gambar_pimpinan ?? null
                        ]) 
                        @endcomponent
                        ...
                        @component('components.textInput', [
                            'label' => 'Email Ketua Biro',
                            'name' => 'email_pimpinan',
                            'value' => $data->email_pimpinan ?? ''
                        ]) 
                        @endcomponent
