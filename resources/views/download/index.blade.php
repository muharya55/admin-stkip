    ...
    <div class="row">
       <div class="col-md-12">
          <div class="card border-0 shadow rounded">
             <div class="card-body"> 
                <a href="/download/create" class="btn btn-md btn-success mb-3">TAMBAH DATA</a>
                                ...
                                @foreach($datas as $key => $item)
                                 <tr class="odd">
                                    ...
                                    <td class="text-center d-flex">
                                      <a href="{{ route('download.edit', $item->id) }}" data-bs-toggle="tooltip" title="Edit" class="p-2"><i class="fa fa-edit text-primary "></i></a>
                                      ...
                                      <form action="{{ route('download.destroy', $item->id) }}" id="delete{{ $item->id }}" method="POST">
                                            @csrf
                                            @method('delete')
                                      </form>
