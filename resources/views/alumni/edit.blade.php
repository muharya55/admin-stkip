               ...
               <div class="card border-0 shadow rounded">
                  <div class="card-body">
                    <form action="{{ route('alumni.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        @component('components.textInput', ['label' => 'Nama', 'value' => $data->nama, 'name' => 'nama']) @endcomponent
                        @component('components.textInput', ['label' => 'Jabatan', 'value' => $data->jabatan, 'name' => 'jabatan']) @endcomponent
                        @component('components.textInput', ['label' => 'Motivasi', 'value' => $data->motivasi, 'name' => 'motivasi']) @endcomponent
                        @component('components.fileinput', ['label' => 'Gambar', 'value' => $data->gambar, 'name' => 'gambar', 'accept' => 'image/*',"col"=>"col-md-5"]) @endcomponent
