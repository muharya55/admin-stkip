               ...
               <div class="card border-0 shadow rounded">
                  <div class="card-body">
                    <form action="{{ route('fakultas.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        @component('components.textInput',['label'=>'Nama Fakultas' ,'name'=>'nama','value'=>$data->nama ]) @endcomponent
                        @component('components.textInput',['label'=>'Singkatan' ,'name'=>'singkatan','value'=>$data->singkatan  ]) @endcomponent
                        @component('components.textInput',['label'=>'Program' ,'name'=>'program','value'=>$data->program  ]) @endcomponent
