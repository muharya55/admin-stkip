    ...
    <div class="row">
       <div class="col-md-12">
          <div class="card border-0 shadow rounded">
             <div class="card-body"> 
                <a href="/buku-panduan/create" class="btn btn-md btn-success mb-3">TAMBAH DATA</a>
                              ...
                              <tbody>
                                ...
                                @foreach($datas as $key => $item)
                                 <tr class="odd">
                                    ...
                                    <td class="text-wrap" style="max-width: 700px;">{{ $item->tahun }} </td>
                                    <td class="text-wrap" style="max-width: 700px;">{{ $item->nama_file }} </td>
                                   
                                    <td class="text-center d-flex">
                                      <a href="{{ route('buku-panduan.edit', $item->id) }}" data-bs-toggle="tooltip" title="Edit" class="p-2"><i class="fa fa-edit text-primary "></i></a>
                                      ...
                                      <form action="{{ route('buku-panduan.destroy', $item->id) }}" id="delete{{ $item->id }}" method="POST">
                                            @csrf
                                            @method('delete')
                                      </form>
